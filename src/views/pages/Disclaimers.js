...
function Disclaimers() {
  return (
    <div class='container'>
      ...
      <p class='smaller'>
        Disclaimer for UDYAMIT SEVA SAMITI FOUNDATION ( उद्यमित सेवा समिति
        फाउंडेशन कार्यक्रम (Support for Entrepreneurship and Employment
        Development), नीति आयोग (नीति दर्पण), श्रम सुविधा पोर्टल, इ अनुदान
        पोर्टल (सामाजिक न्याय एवं अधिकारिता विभाग) से संबद्ध और कॉर्पोरेट कार्य
        मंत्रालय सेक्शन 8 &nbsp;अधिनियम के तहत स्वीकृत स्वतंत्र गैर शासकीय निकाय
        अमोघ सेवा फाउंडेशन के अंतर्गत कार्य कर रही है&nbsp;)
      </p>
      <p>
      ...
      <h2>Disclaimers for UDYAMIT </h2>
      <p>
        All the information on this website - https://udyamit.in/ - is published
        in good faith and for general information purpose only. UDYAMIT does not
        ...
        this website (UDYAMIT ), is strictly at your own risk. UDYAMIT will not
