        ...
        <main id='main' class='site-main'>
          ...
          >
            ...
            <div class='entry-content' itemprop='text'>
              ...
              <p>Thank you for shopping at Udyamit.</p>
              <p>
              ...
              <ul>
                <li>
                  <p>
                    ...
                    Udyamit Seva Samiti Foundation, 70/1/2, Gali No. 25, Marble
                    Market, Sector 2 Rohini, New Delhi.
                  </p>
                </li>
                <li>
                  <p>
              ...
              <ul>
                <li>
                  <p>By email: support@udyamit.in</p>
                </li>
                <li>
                  <p>
                    By visiting this page on our website:{' '}
                    <a
                      href='https://udyamit.in/contact-us'
                      rel="external nofollow noopener noreferrer"
                      target='_blank'
                    >
                      https://udyamit.in/contact-us
                    </a>
                  </p>
                </li>
                <li>
